...
public void onEvent(Event event) throws Exception{
			    ...
			    tr${task_index}.addEventListener(Events.ON_CLICK,new org.zkoss.zk.ui.event.EventListener(){
					public void onEvent(Event event) throws Exception{
						doEvent("transition-list","${task[0]}");
					}
		   	    });	
...
//						grid.setAutopaging(true);   	
						...
						Textbox tb1=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}description")); 
						tb1.setParent(row1);
						tb1.setRows(3);
						tb1.setWidth("100%");
						...
						StringTokenizer dateT=new StringTokenizer((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}dueDate")," ");
						...
						row3.setParent(rows);
						   new Label("BPM Priority: ").setParent(row3);
					           Textbox tb3=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}priority")); 
	 					   tb3.setParent(row3);
						   tb3.setWidth("50px");
						...
						StringTokenizer dateT=new StringTokenizer((String)map${task_index}.get("{http://www.alfresco.org/model/content/1.0}created")," ");
						String dt=dateT.nextToken();
						String td=dateT.nextToken();
						java.text.DateFormat formatter ; 
						java.util.Date date ; 
						...
						row5.setParent(rows);
						   new Label("BPM Comment: ").setParent(row5);
					           Textbox tb5=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}comment")); 
	 					   tb5.setParent(row5);
					           tb5.setRows(3);
						   tb5.setWidth("350px");
						...
						StringTokenizer dateT=new StringTokenizer((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}completionDate")," ");
						...
						row7.setParent(rows);
						   new Label("BPM Outcome: ").setParent(row7);
					           Textbox tb7=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}outcome")); 
	 					   tb7.setParent(row7);
					           tb7.setRows(3);
						   tb7.setWidth("350px");
						...
						row8.setParent(rows);
						   new Label("CM Owner: ").setParent(row8);
					           Textbox tb8=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/content/1.0}owner")); 
	 					   tb8.setParent(row8);
						   tb8.setWidth("150px");
						...
						row9.setParent(rows);
						   new Label("CM Description: ").setParent(row9);
					           Textbox tb9=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/content/1.0}description")); 
	 					   tb9.setParent(row9);
					           tb9.setRows(3);
						   tb9.setWidth("350px");
						...
						row10.setParent(rows);
						   new Label("BPM Workflow Description: ").setParent(row10);
					           Textbox tb10=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}workflowDescription")); 
						...
						row11.setParent(rows);
						   new Label("BPM Status: ").setParent(row11);
					           Textbox tb11=new Textbox((String)map${task_index}.get("{http://www.alfresco.org/model/bpm/1.0}status")); 
		    ...
		    Treecell tcInitiator${task_index}=new Treecell("${task[6]}");

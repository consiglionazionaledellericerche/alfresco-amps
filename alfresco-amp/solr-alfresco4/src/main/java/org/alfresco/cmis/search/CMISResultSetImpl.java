...
public class CMISResultSetImpl implements CMISResultSet, Serializable
{
	...
	private Map<String, List<Pair<String, Integer>>> facets;
	...
	private List<String> fieldFacets;
	...
	public CMISResultSetImpl(Map<String, ResultSet> wrapped, CMISQueryOptions options, LimitBy limitBy, NodeService nodeService, Query query,
			CMISDictionaryService cmisDictionaryService, DictionaryService alfrescoDictionaryService, Long numberFound)
	{
		...
		facets = new HashMap<String, List<Pair<String, Integer>>>();
	}
	...
	@Override
	public void addFacet(String facet, List<Pair<String, Integer>> fieldFacet) {
		
		facets.put(facet, fieldFacet);
	...
	@Override
	public void setFieldFacets(List<String> l) {
		this.fieldFacets = l;

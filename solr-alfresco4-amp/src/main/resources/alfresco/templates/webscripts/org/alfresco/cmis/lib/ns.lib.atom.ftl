...
[#macro solrNS]http://lucene.apache.org/solr[/#macro]
...
[#macro feedNS]xmlns="[@atomNS/]" xmlns:app="[@appNS/]" xmlns:cmisra="[@cmisraNS/]" xmlns:cmis="[@cmisNS/]" xmlns:alf="[@alfNS/]" xmlns:opensearch="[@opensearchNS/]" xmlns:solr="[@solrNS/]"[/#macro]
